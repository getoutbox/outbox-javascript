 ...
 */
export declare type ResourceDescriptor = Message<"google.api.ResourceDescriptor"> & {
  /**
 ...
 */
export declare type ResourceReference = Message<"google.api.ResourceReference"> & {
  /**
